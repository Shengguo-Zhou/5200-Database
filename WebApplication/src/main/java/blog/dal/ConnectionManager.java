 ...
 * interact with
 * each MySQL table. The DAO java classes will use ConnectionManager to open and
 * close
 * connections.
 * 
 * Instructions:
 * 1. Install MySQL Community Server. During installation, you will need to set
 * up a user,
 * password, and port. Keep track of these values.
 * 2. Download and install Connector/J:
 * http://dev.mysql.com/downloads/connector/j/
 * 3. Add the Connector/J JAR to your buildpath. This allows your application to
 * use the
 * Connector/J library. You can add the JAR using either of the following
 * methods:
 ...
 * 8.0\mysql-connector-java-8.0.16-bin.jar
 * B. If you already have a Java project created, then go to your project
 * properties.
